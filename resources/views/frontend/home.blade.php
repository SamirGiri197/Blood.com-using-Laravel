...
<section id="events" class="events-section pt-3 mt-5">
   <div class="container-fluid">
            <h1 class="heading-style">Events</h1>
            <div class="row">
               <div class="col-lg-4 col-md-6 mb-4">
                  <div class="event-card">
                     ...
                     <h3 class="event-header"> Blood Donation Campaign Organized by Indrapur Jaycees </h3>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 mb-4">
                     <div class="event-card">
                                 ...
                                 <div class="card-body row">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <div class="row mt-3">
                                          ...
                                          <div class="col-md-6  col-sm-6">
                                          <a href="{{route('mail.form')}}" class="btn btn-danger form-control" id="chat-icon"><i class="fa-solid fa-message"></i> Email</a>
                                          </div>
                                 ...
                                 <div class="card-body row">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <div class="row mt-3">
                                          ...
                                          <div class="col-md-6  col-sm-6">
                                             <button class="btn btn-danger form-control" id="chat-icon"><i class="fa-solid fa-message"></i> Email</button>
                                          </div>
                                          <div  class="comment-section" style="display:none;">
                                             <div class="row mt-2">
                                                   <div class="form-group col-md-10 col-sm-10">
                              ...
                              <div class="card  bg-light" style="border: 1px solid;">
                                 ...
                                 <div class="card-body row">
                                    ...
                                    <div class="col-md-8">
                                       ...
                                       <div class="row mt-3">
                                          <div class="col-md-6  col-sm-6">
                                             <a class="btn btn-primary form-control comment-btn"><i class="fa fa-comment"></i> Comment</a>
                                          </div>
                                          <div class="col-md-6  col-sm-6">
                                             <a href="{{route('mail.form')}}" class="btn btn-danger form-control" id="chat-icon"><i class="fa-solid fa-message"></i> Email</a>
                                          </div>
