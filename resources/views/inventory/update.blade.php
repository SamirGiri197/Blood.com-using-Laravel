...
<form action="{{ route('bloodInventory.update', $bloodInventory->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <input type="number" name="pints_available" id="pints_available" value="{{ $bloodInventory->pints_available }}">
